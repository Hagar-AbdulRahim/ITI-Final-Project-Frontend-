...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      dispatch(loginFailure(error.message || 'حدث خطأ في إنشاء الحساب'));
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#fbf9f6] font-sans">
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-center items-center p-12">
          ...
          <div className="bg-[#2c5b36]/80 backdrop-blur-md rounded-2xl p-8 max-w-md border border-white/10 text-white shadow-xl">
            ...
            <div className="flex items-center gap-4">
              <img src="https://ui-avatars.com/api/?name=Ibrahim+AlQahtani&background=random" alt="Doctor" className="w-12 h-12 rounded-full border-2 border-white/20" />
              <div>
      ...
      {/* Left Side - Form */}
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-[#fdfdfd] relative">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-center mt-2 pb-2">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-700 mr-2">
                أوافق على <a href="#" className="font-medium text-[#154b23] hover:underline">الشروط والأحكام</a> و <a href="#" className="font-medium text-[#154b23] hover:underline">سياسة الخصوصية</a>.
              </label>
            </div>
